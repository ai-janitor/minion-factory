# Clean Requirements — v2 Unbiased Derivation

Derived from: .planning/v2/raw-snapshot.md only. No prior clean or upstream feedback consulted.

v2 is a remediation iteration. The system is built and working. These requirements organize
the remaining 73 backlog items into actionable work streams by domain and priority.
