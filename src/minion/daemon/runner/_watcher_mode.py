...
Purpose: Watcher mode — legacy direct-DB message watching.
Rationale: Extracted into own module for single-responsibility daemon transport.
Responsibility: Watcher mode — legacy direct-DB message watching. NOT responsible for unrelated concerns.
