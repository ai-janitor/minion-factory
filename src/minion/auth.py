...
TOOL_CATALOG: dict[str, tuple[set[str], str]] = {
    ...
    "list-tasks":            (VALID_CLASSES, "List tasks with filters"),
    ...
    "reopen-task":           ({"lead"}, "Reopen a terminal task back to an earlier phase"),
    "complete-phase":        (VALID_CLASSES, "Complete your phase — DAG routes to next stage"),
