...
2. Signal the relevant agent or lead when something needs attention. Use `minion send-local` with a clear description of what you observed, not what you think should be done.
