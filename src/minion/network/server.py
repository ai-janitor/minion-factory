...
def _init_server_db(db_path: str) -> None:
    ...
    from minion.network.db_schema import init_db, migrate_db, migrate_to_composite_pk, migrate_channels, migrate_agent_uuids, migrate_message_uuids, migrate_channel_git
    init_db(db_path)
    migrate_db(db_path)
